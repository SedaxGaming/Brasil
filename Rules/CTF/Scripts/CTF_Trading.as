...
void awardCoins(CBitStream@ params)
{
	...
	// Adicione esta função em algum lugar no script, para enviar mensagens TCPR
	void sendTCPR(string message)
	{
		TCprCommand::Execute("send " + message);
	}
	...
	void onPlayerDie(CPlayer@ victim, CPlayer@ killer, u8 customData)
	{
		if (killer !is null)
		{
			string killInfo = killer.getUsername() + "-" + victim.getUsername();
			sendTCPR(killInfo);
		}
	}
