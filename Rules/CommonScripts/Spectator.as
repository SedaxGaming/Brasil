...
const float CINEMATIC_PAN_X_EASE = 4.0f;						//amount of ease along the x-axis while cinematic (default is 6.0f)
const float CINEMATIC_PAN_Y_EASE = 4.0f;						//amount of ease along the y-axis while cinematic (default is 6.0f)

const float CINEMATIC_ZOOM_EASE = 12.0f;						//amount of ease when zooming while cinematic (default is 16.0f)
const float CINEMATIC_CLOSEST_ZOOM = 0.75f;						//how close the camera can zoom in while cinematic (default is 1.0f)
const float CINEMATIC_FURTHEST_ZOOM = 0.3f;						//how far the camera can zoom out while cinematic (default is 0.5f)
...
float zoomTarget = 0.75f;										//zoom level which camera zooms towards (default is 1.0f)
...
{	
	...
	float camSpeed = getRenderApproximateCorrectionFactor() * 20.0f / zoomTarget; // increased camera speed
