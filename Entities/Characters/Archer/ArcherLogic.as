...
// x = WEAKSHOT_CHARGE
const int WEAKSHOT_CHARGE = 8; // 12 (x+1) in reality
const int MIDSHOT_CHARGE = 10; // 24 (x+13) in reality
const int FULLSHOT_CHARGE = 20; // 36 (x+25) in reality
const int TRIPLESHOT_CHARGE = 50; // 100 (x+89) in reality 
